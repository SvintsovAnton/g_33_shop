...
public class TokenService {
    ...
    public TokenService(@Value("${key.access}") String accessSecretPhrase, @Value("${key.refresh}") String refreshSecretPhrase, RoleRepository roleRepository) {
    ...
    public boolean validateAccessToken(String accessTocken) {
        return validateToken(accessTocken, accessKey);
    }
